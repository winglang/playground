    ...
    >
      <div className="relative h-[24px] w-[24px] leading-[20px]">
        ...
        >
          ...
          />
          <path
            d="M22 13C24.357 12.9993 25.711 13.1707 28.043 13.513C29.627 13.746 30.75 15.139 30.75 16.741V22.759C30.75 24.361 29.627 25.754 28.043 25.987C26.161 26.2634 24.2644 26.4284 22.363 26.481C21.9735 26.4909 21.6024 26.6493 21.326 26.924L17.25 31V26.356C16.142 26.27 15.044 26.147 13.957 25.987C12.373 25.754 11.25 24.36 11.25 22.76V22.759V19.75"
            stroke="currentColor"
            strokeWidth="2.5"
            strokeLinecap="round"
            strokeLinejoin="round"
