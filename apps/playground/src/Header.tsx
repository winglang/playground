  ...
  <div className="flex justify-between w-full">
    ...
    <div className="flex items-center justify-end">
      <div className="flex items-center justify-end flex-none gap-4 text-slate-700 dark:text-[#f1f0f1] hover:text-slate-600 dark:hover:text-[#2ad5c1]">
        ...
        <a href="https://github.com/winglang/wing" target="_blank" className="flex gap-2 border-[1px] border-gray-400 dark:border-[#26413c] rounded-[4px] items-center font-sans text-[15px] py-[8px] px-[16px]">
          <div className="h-[24px]">
