...
export function Header({ currentMode, onToggleTheme }: HeaderProps) {
  ...
  <div className="flex justify-between w-full">
      ...
      <div className={classNames(
        "flex grow items-center justify-end flex-none gap-6",
        ...
        <a href="https://t.winglang.io/slack" className="flex items-center justify-center h-6">
