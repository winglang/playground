...
If the counter was not atomic, the value of the last file would not be 99 because of race conditions.

1. In the Wing Simulator, invoke the "Invoke Me!" Function.
2. This function pushes the 99 messages to the queue.
