...
**Reminder:** This is code that runs once, at compile time, to set up the infrastructure of the app in the cloud (create the DB, set up queues, API endpoints, etc).
