...
???? define "assignability" and "reassignability"

### Immutable by Default

The first protection Wing offers us against scenarios like the one in the previous steps is the concept of immutable by default.
...
Change the `let` declaration in line 5 to `let var` and see the resulting error:
