...
After you've added the code that pushes to the queue, you should notice how the simulator shows the
relationship between the function resource and the queue resource.
...
Now invoke the **cloud.Function** in the simulator and check out how the queue has new messages in
it (remember **Approx size**?).
