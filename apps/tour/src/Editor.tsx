...
export const ReactMonacoEditor: React.FC<EditorProps> = ({
  ...
  const downloadCompiledCode = async (target: Target) => {
    ...
    const result = await compiler.compile(
      new CompilationRequest(editorRef.current?.getValue()!, target),
    );
    if (result.error) {
                ...
                <div data-cueid="instructions" className="grow flex flex-col">
                  ...
                  <div className="w-full relative mt-[1rem]">
                    ...
                    <div
                      ...
                      style={{
                        width: `${
                          ((currentStepIndex + 1) / tutorial.pages.length) * 100
                        }%`,
                      }}
                    />
                  </div>
                  ...
                  <div className="text-white flex gap-4 items-center pt-4 overflow-auto">
                    ...
                    <div className="grow text-center items-center truncate">
                      ...
                      >
                        ...
                        <span>
                          {currentStepIndex + 1}/{tutorial.pages.length}
                        </span>
                      </div>
                    </div>
