...
export class InfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const image = ecs.ContainerImage.fromAsset(join(__dirname, "../../compiler"));
    ...
    const imageName = fargate.taskDefinition.findContainer('compiler')!.imageName
    const repo = ecr.Repository.fromRepositoryName(this, "CompilerRepo", imageName)
    new PreviewsBot(this, "PreviewsBot", repo);
