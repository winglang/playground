...
export function Actions({ onRun, isRunDisabled, onTfAws, onTfGcp, onTfAzure }: ActionProps) {
  ...
  return (
    <div className="flex flex-row items-center justify-center">
      <button
        className="m-0.5 p-2 text-[#f1f0f1] bg-[#ffffff20] text-[14px] inline-flex gap-2 items-center font-medium outline-none transition ease-in-out rounded hover:bg-[#1E293B]"
        onClick={onTfAws}
      >
        Compile to AWS
      </button>
